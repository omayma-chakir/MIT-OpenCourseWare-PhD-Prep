...
**Level:** Undergraduate  
**Term Taught:** Spring 2010  
**Primary Text:** *Introduction to Linear Algebra* by Prof. Gilbert Strang (Readings cover 4th and 5th editions)
...
| **36** | *Course review* |
| **37** | *Exam 3: Chapters 1-8* |
| **38** | Numerical linear algebra |
| **39** | Computational science |
| **40** | *Final exam* |

## 📦 Learning Resources Included
* Lecture Videos : https://ocw.mit.edu/courses/18-06-linear-algebra-spring-2010/video_galleries/video-lectures/
